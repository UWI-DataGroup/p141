...
**  DO-FILE METADATA
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\4_quality_deaths_2020.smcl", replace
** HEADER -----------------------------------------------------

***************
** LOAD DATASET  
***************
use "`datapath'\version04\3-output\2020_deaths_cleaned_dqi_dc"
...
keep abstiming*
gen recid=1
save "`datapath'\version04\2-working\2020_deaths_dqi_da_timing" ,replace
restore
/*
** Timing per record
...
drop _merge
save "`datapath'\version04\3-output\2020_deaths_dqi_da" ,replace
...
putpdf paragraph
putpdf text ("Death Data: 2020 Pt.1"), font(Helvetica,10)
putpdf paragraph
putpdf text ("Date Prepared: 09-Sep-2020"),  font(Helvetica,10)
putpdf paragraph
...
putpdf paragraph
putpdf image  "`datapath'\version04\2-working\accuracy rate formula.png"
putpdf paragraph

putpdf save "`datapath'\version04\3-output\2020-09-09_quality_report_AH.pdf", replace
putpdf clear
...
putpdf save "`datapath'\version04\3-output\2020-09-09_quality_report_KG.pdf", replace
putpdf clear
...
putpdf save "`datapath'\version04\3-output\2020-09-08_quality_report_NR.pdf", replace
putpdf clear
...
putpdf save "`datapath'\version04\3-output\2020-09-09_quality_report_TH.pdf", replace
putpdf clear
...
putpdf save "`datapath'\version04\3-output\2020-09-09_quality_report_intern.pdf", replace
putpdf clear
...
putpdf paragraph
putpdf image  "`datapath'\version04\2-working\error rate formula.png"
putpdf paragraph
...
putpdf save "`datapath'\version04\3-output\2021-03-31_quality_report_KG.pdf", replace
putpdf clear
...
putpdf save "`datapath'\version04\3-output\2021-03-31_quality_report_TH.pdf", replace
putpdf clear
...
putpdf save "`datapath'\version04\3-output\2021-03-31_quality_report_intern.pdf", replace
putpdf clear


save "`datapath'\version04\3-output\2020_deaths_report_dqi_da" ,replace
