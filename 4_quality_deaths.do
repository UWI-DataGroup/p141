...
** LOAD DATASET  
***************
use "`datapath'\version06\3-output\2020_deaths_cleaned_dqi_dc"
...
keep abstiming*
gen recid=1
save "`datapath'\version06\2-working\2020_deaths_dqi_da_timing" ,replace
restore
/*
** Timing per record
...
gen recid=1
merge 1:1 recid using "`datapath'\version06\2-working\2020_deaths_dqi_da_timing"
format absper* corrper* corrrecper* nocorrrecper* accuracy* abstiming* %9.0f
drop _merge
save "`datapath'\version06\3-output\2020_deaths_dqi_da" ,replace
...
putpdf paragraph
putpdf text ("Death Data: 2020 Pt.1 + Pt.2"), font(Helvetica,10)
putpdf paragraph
putpdf text ("Date Prepared: 15-Jul-2021"),  font(Helvetica,10)
putpdf paragraph
...
putpdf paragraph
putpdf image  "`datapath'\version06\2-working\error rate formula.png"
putpdf paragraph

putpdf save "`datapath'\version06\3-output\2021-07-15_quality_report_AH.pdf", replace
putpdf clear
...
putpdf save "`datapath'\version06\3-output\2021-07-15_quality_report_KG.pdf", replace
putpdf clear
...
putpdf save "`datapath'\version06\3-output\2021-07-15_quality_report_TH.pdf", replace
putpdf clear
...
putpdf save "`datapath'\version06\3-output\2021-07-15_quality_report_intern.pdf", replace
putpdf clear


save "`datapath'\version06\3-output\2020_deaths_report_dqi_da" ,replace
...
putpdf paragraph
putpdf image  "`datapath'\version06\2-working\accuracy rate formula.png"
putpdf paragraph
...
putpdf save "`datapath'\version06\3-output\2020-09-08_quality_report_NR.pdf", replace
putpdf clear
