...
**  DO-FILE METADATA
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\1_prep_deaths_2019_v02.smcl", replace
** HEADER -----------------------------------------------------

********************
** DATA PREPARATION  
********************
use "`datapath'\version03\2-working\2019_deaths_imported_dp_v02"
...
replace tfdddoa="23jun2020 00:00:00" if record_id==2277
replace tfdddoa="10jun2020 00:00:00" if record_id==2278
replace tfdddoa=subinstr(tfdddoa," 00:00:00","",.) if tfdddoa!="" //1 change
generate tfdddoa2=date(tfdddoa,"DMY")
...
save "`datapath'\version03\2-working\2019_deaths_prepped_dp_v02" ,replace
