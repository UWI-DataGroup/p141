...
** JC 30jun2022+11jul2022+14jul2022+20jul2022+21jul2022+03aug2022: Below records (3232 - 3246) added by KG after completion of 2021 cleaning so manually reviewed and cleaned; Included in this process in prep for cancer annual report process
import excel using "`datapath'\version07\1-input\BNRDeathData2021-Exporting32323246_DATA_2022-08-03_0829_excel.xlsx" , firstrow case(lower)
count //15
...
count //3,112; 3231; 3232; 3236; 3242; 3243; 3245
...
count //2695; 3231; 3232; 3233; 3236; 3242; 3243; 3245; 3246
...
keep if record_id==3232|record_id==3233|record_id==3234|record_id==3235|record_id==3236|record_id==3237|record_id==3238|record_id==3239|record_id==3240|record_id==3241|record_id==3242|record_id==3243|record_id==3244|record_id==3245|record_id==3246
