...
replace corr_KG=+1 if record_id==38|record_id==318 //2 changes
replace corr_AH=+1 if record_id==654 //1 change
...
replace corr_KG=+1 if record_id==186 //1 change
...
replace corr_AH=+1 if record_id==698 //1 change
...
replace corr_AH=+1 if record_id==1311|record_id==1309 //2 changes
replace corr_KG=+1 if record_id==891 //1 change
replace corr_NR=+1 if record_id==1723 //1 change
...
replace corr_KG=+1 if record_id==2682 //1 change
...
** (19) invalid - female with 'male' NRN
count if sex==2 & regex(substr(nrn,-2,1), "[1,3,5,7,9]") & !(strmatch(strupper(nrn), "*-9999*")) //
//list record_id ddda pname nrn sex cod* if sex==2 & regex(substr(nrn,-2,1), "[1,3,5,7,9]") & !(strmatch(strupper(nrn), "*-9999*"))
//list cod1a if sex==2 & regex(substr(nrn,-2,1), "[1,3,5,7,9]") & !(strmatch(strupper(nrn), "*-9999*"))
recode sex 2=1 if record_id==
** (19) invalid - male with 'female' NRN
